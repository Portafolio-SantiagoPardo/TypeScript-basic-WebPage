...
let cursos = [
        ...
        new Curso("Pruebas automáticas",25,50,false,2020),
        new Curso("Practicas de arquitectura",30,75,true,2020)
]
...
function mostrarEstadisticas(aprendiz:Aprendiz):void{
    let numeroCertficados:number = aprendiz.darCursosCertificados();
    let trElement:HTMLElement = document.createElement("tr");
    trElement.innerHTML = `<td><b>Cursos Certificados</b></td><td>${numeroCertficados}</td>`;
